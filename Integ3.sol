...
contract Auction {
    ...
    //this function should be executed automatically after crossing start time
    // function startAuction() public afterDate {
    ...
    // function test () private afterDate {
    //     isAuctionStarted = true;
    // }
    // mapping(address => uint) public bids; uint x= bids[ biddersaddress(i) ];
    // string[] public biddersaddress;
